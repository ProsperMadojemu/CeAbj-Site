document.addEventListener('DOMContentLoaded', async () => {
    ...
    function attachDropdownEvents(users) {
        ...
        document.getElementById('updateLeaderButton').addEventListener('click', async function() {
            try {
                if (!currentUserData) {
    ...
    async function updateLeader(leaderId) {
        try {
            const updateData = new FormData(document.getElementById('updateLeaderForm'));
            const formJSON = {};
